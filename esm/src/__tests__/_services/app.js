import { deleteApp as deleteAppAdmin, getApps as getAppsAdmin, initializeApp as initializeAdminApp, } from 'firebase-admin/app';
...
const firestoreEmulatorUrl = (path) => `http://${localhost}:${emulators.firestore.port}/emulator/v1/projects/${projectId}${path}`;
beforeAll(async () => {
