...
export declare type IUserLocal = Type.Merge<
  IUser,
  {
    timestamp: string
  }
>
export declare type IUserJson = Type.Merge<
  IUser,
  {
    timestamp: string
  }
>
export declare const UserJsonType: z.ZodObject<
  z.extendShape<
    {
      name: z.ZodString
      displayName: z.ZodUnion<[z.ZodString, z.ZodNull]>
...
export declare const UserModel: DataModel<
  z.ZodObject<
    {
      name: z.ZodString
      displayName: z.ZodUnion<[z.ZodString, z.ZodNull]>
...
>
export declare const PostModel: DataModel<
  z.ZodUnion<
    [
      z.ZodObject<
        {
  ...
  {}
>
export declare const PostAModel: DataModel<
  z.ZodObject<
    {
      type: z.ZodLiteral<'a'>
      text: z.ZodString
