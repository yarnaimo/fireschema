...
export declare const firestoreModelWithDup: FirestoreModel<{
  '/posts/{_post}': {
    ...
    model: import('../../core/index.js').DataModel<
      import('zod').ZodUnion<
        [
    ...
    '/users/{uid}': {
      model: import('../../core/index.js').DataModel<
        ...
        (
          data: IUser,
          snap:
            | import('@firebase/firestore').QueryDocumentSnapshot<IUser>
            | FirebaseFirestore.QueryDocumentSnapshot<IUser>,
...
export declare const _tcollections: (
  app: F,
  env: Env,
) => {
  typedFirestore: TypedFirestoreUniv<
    FirestoreModel<{
      'function getCurrentAuthUserDoc()': string
      'function isAdmin()': string
      'function requestUserIs(uid)': string
  ...
  >
  typedFirestoreWithCollectionDup: TypedFirestoreUniv<
    FirestoreModel<{
      '/posts/{_post}': {
        'function test()': string
        model: import('../../core/index.js').DataModel<
  ...
  userData: import('type-fest').Simplify<
    import('type-fest/source/merge').Merge_<
      IUser,
      {
        timestamp:
...
export declare type UserU = IUserLocal &
  STypes.DocumentMeta<F> &
  STypes.HasLoc<'versions.users'> &
  STypes.HasT<IUser> &
  STypes.HasId
export declare type PostU = (IPostA | IPostB) &
  STypes.DocumentMeta<F> &
