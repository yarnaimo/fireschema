...
const functionsApp = (0, app_js_1.getTestAppWeb)('user').functions(
  'asia-northeast1',
)
;(0, functions_1.connectFunctionsEmulator)(
  functionsApp,
  emulator_js_1.localhost,
  emulator_js_1.emulators.functions.port,
)
exports.typedCaller = new index_js_1.TypedCaller(functionsApp)
exports.typedTopic = new index_js_1.TypedTopic(
  new pubsub_1.PubSub({
