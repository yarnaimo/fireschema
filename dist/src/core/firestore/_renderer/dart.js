 ...
 *   - data._updatedAt is server timestamp
 */
const metaRules = index_js_2.rules.orMultiline(index_js_2.rules.and('request.method == "create"', `data.${index_js_1._createdAt} == request.time`, `data.${index_js_1._updatedAt} == request.time`), index_js_2.rules.and('request.method == "update"', `data.${index_js_1._createdAt} == resource.data.${index_js_1._createdAt}`, `data.${index_js_1._updatedAt} == request.time`));
