...
const renderEntities = ($allow, model, collectionPath) => {
    var _a;
    const entities = model
        ? (0, transformer_dart_js_1.schemaToClassWithMeta)(model.schema, (_a = model.modelName) !== null && _a !== void 0 ? _a : 'UNDEFINED', collectionPath)
        : null;
