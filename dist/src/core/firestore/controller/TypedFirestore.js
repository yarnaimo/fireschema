...
class TypedFirestoreUniv extends TypedFDBase_js_1.TypedFDBase {
  ...
  collectionGroup(collectionName) {
    const collectionOptionsList = (0, _object_js_1.getCollectionOptionsByName)(
    ...
    return new TypedCollectionRef_js_1.TypedSelectable(
      { ...this.options, loc },
  ...
  wrapDocument(rawDocRef) {
    ...
    return new TypedDocumentRef_js_1.TypedDocumentRef(
      { ...this.options, loc },
      rawDocRef,
    )
  }
  ...
  batch() {
    return new TypedWriteBatch_js_1.TypedWriteBatch(
      this.options.firestoreStatic,
      (0, _universal_js_1.writeBatchUniv)(this.raw),
    )
  }
}
