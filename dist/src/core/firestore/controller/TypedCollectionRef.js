...
exports.TypedCollectionRef =
  exports.TypedSelectable =
  exports.TypedQueryRef =
  exports.TypedQuerySnap =
    void 0
...
class TypedQuerySnap {
  constructor(options, raw) {
    ...
    this.docs = raw.docs.map((rawDocSnap) => {
      return new TypedDocumentRef_js_1.TypedQueryDocumentSnap(
        options,
        rawDocSnap,
      )
    })
...
class TypedQueryRef {
  constructor(options, origQuery, skipDecoder) {
    ...
    this.collectionOptions = (0, _object_js_1.getSchemaOptionsByLoc)(
      options.schemaOptions,
      options.loc,
    )
    const convertedQuery = skipDecoder
      ? origQuery
      : (0, _query_cache_js_1.withDecoder)(
          origQuery,
          this.collectionOptions.model,
          name,
        )
...
class TypedSelectable extends TypedQueryRef {
  constructor(options, origQuery, skipDecoder) {
    ...
    const selectorsConstraint = this.collectionOptions.model.selectors(
      (0, _universal_js_1.queryBuilderUniv)(this.raw),
      ...
      Object.entries(selectorsConstraint).map(([k, fn]) => {
        return [
          ...
          (...args) => {
            ...
            const query = (0, _universal_js_1.queryUniv)(
              this.raw,
              queryConstraints,
            )
...
class TypedCollectionRef extends TypedSelectable {
  ...
  parentDocument() {
    ...
    const parentTypedCollection = new TypedCollectionRef(
