...
exports.TypedDocumentRef =
  exports.TypedQueryDocumentSnap =
  exports.TypedDocumentSnap =
  exports.withRefTransformer =
  exports.DocumentNotExistsError =
    void 0
...
class TypedDocumentSnap {
  ...
  data({ snapshotOptions, transformer } = {}) {
    ...
    return (_a =
      transformer === null || transformer === void 0
        ? void 0
        : transformer(data, this)) !== null && _a !== void 0
      ? _a
      : data
  }
}
...
class TypedDocumentRef extends TypedFDBase_js_1.TypedFDBase {
  ...
  async setMerge(dataOrFn) {
    return this.wrapWriteResult(
      await (0, _universal_js_1.setDocUniv)(
        this.raw,
        ...this.dataHelper.setMerge(dataOrFn),
      ),
    )
  }
  async update(dataOrFn) {
    return this.wrapWriteResult(
      await (0, _universal_js_1.updateDocUniv)(
        this.raw,
        ...this.dataHelper.update(dataOrFn),
      ),
    )
  }
  async delete() {
    return this.wrapWriteResult(
      await (0, _universal_js_1.deleteDocUniv)(this.raw),
    )
  }
}
