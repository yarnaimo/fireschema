...
declare type GetU<
  ...
  D,
> = D extends STypes.Model.Decoder<any, infer U> ? U : z.infer<S>
export declare type InferDataModelT<M extends DataModel<any, any, any>> =
  z.infer<M['schema']>
export declare type InferDataModelU<M extends DataModel<any, any, any>> = GetU<
  M['schema'],
  M['decoder']
>
export declare type InferDataModelSL<M extends DataModel<any, any, any>> =
  ReturnType<M['selectors']>
...
export declare type InferFirestoreModelS<M extends FirestoreModel<any>> =
