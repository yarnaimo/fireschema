...
export declare namespace STypes {
  type InferDocT<D extends FTypes.FirestoreApp | FTypes.DocumentRef<unknown>> =
    D extends FTypes.DocumentRef<infer T> ? T : never
  type InferCollectionT<C extends FTypes.CollectionRef<unknown>> =
  ...
  namespace Model {
    ...
    type Selectors<T, SL extends SelectorsConstraint> = (
